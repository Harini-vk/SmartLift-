...
#     if count > 4:
#         cv2.putText(frame, "Over Capacity!", (10, 70),
#                     cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0, 0, 255), 3)

#     cv2.imshow("Smart Elevator - HOG People Detection", frame)
...
# Load YOLO model
model = YOLO('yolov8n.pt')  # or yolov8s, etc.
...
# Open camera
cap = cv2.VideoCapture("stock2.mp4")
